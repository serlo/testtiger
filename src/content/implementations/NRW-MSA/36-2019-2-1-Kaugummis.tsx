        ...
        task({ data }) {
          return (
            <>
              ...
              <p>
                Berechne, wie viel Kaugummikugeln in einer 300-Gramm-Packung
                sind.
              </p>
            </>
          )
          ...
          return (
            <>
              <p>
                ...
                passen und rechnet <br></br>({pp(data.length)} ·{' '}
                {pp(data.length)} · {pp(data.height)}) :{' '}
                {pp(
                  Math.round(
                    (((4 / 3) * Math.pow(data.dia / 2, 3) * Math.PI) / 1000) *
                      100,
                ...
                {pp(
                  Math.round(
                    ((data.length * data.length * data.height) /
                      (((4 / 3) * Math.pow(data.dia / 2, 3) * Math.PI) /
                        1000)) *
                      100,
                  ) / 100,
                )}
        ...
        solution({ data }) {
          return (
            <>
              ...
              <p>
                Geteilt durch das Volumen einer Kugel hat sie versucht die
                Anzahl der Kaugummis zu bestimmen, die in den Behälter passen.
              </p>
              <p>
      ...
      },
      {
          ...
          return (
            <>
              <p>
                ...
                weißen Kaugummikugeln in den Automaten. Durch Drehen am
                Automaten enthält man zufällig eine rote oder eine weiße
                Kaugummikugel.
              </p>
              <p>
                d) Begründe, dass die Wahrscheinlichkeit, beim ersten Drehen
                eine rote Kaugummikugel zu erhalten,{' '}
        ...
        solution({ data }) {
          ...
          return (
            <>
              <p>
                Eine Kaugummikugel zufällig aus dem Behälter zu ziehen
                entspricht einem Laplace-Zufallsexperiment.
              </p>
              <p>
      ...
      },
      {
        task({ data }) {
          ...
          return (
            <>
              <p>
                e) Das Baumdiagramm (Abbildung 2) zeigt die
                Wahrscheinlichkeiten, beim ersten und zweiten Drehen eine rote
                oder weiße Kaugummikugel zu erhalten.
              </p>
        ...
        solution({ data }) {
          ...
          return (
            <>
              ...
              <p>
                {' '}
                Achte dabei darauf, dass beim zweiten Zug eine Kugel der
                gezogenen Farbe weniger vorhanden ist.
              </p>
              <svg viewBox="0 0 400 382">
                <image
                  href="/content/NRW_MSA_Kaugummi_Baumdiagramm.PNG"
          ...
          return (
            <>
              <p>
                ...
                verschiedenfarbige Kaugummikugeln zu erhalten, ist kleiner als
                50 %.{'"'}
              </p>
