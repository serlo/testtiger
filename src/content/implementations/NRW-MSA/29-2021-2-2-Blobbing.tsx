    ...
    main: [
      {
        task({ data }) {
          return (
            <>
              <p>
                a) Skizziere zu den Werten aus Tabelle 1 den passenden Graphen
                in dem abgebildeten Koordinatensystem (Abbildung 3).
              </p>
            </>
          )
        },
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                b) Überprüfe, ob es zwischen der Absprunghöhe und der
                Sprungdauer einen linearen Zusammenhang gibt. Notiere deinen
                Lösungsweg.
              </p>
            </>
          )
      ...
      },
      {
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Um a zu berechnen, setze den Punkt (0|1) in f(x) ein und löse
                die Gleichung:
              </p>
              <p>
      ...
      },
      {
        task({ data }) {
          ...
          return (
            <>
              <p>
                e) Die Flugbahn von Blobber A kann somit durch die Funktion f
                mit{' '}
              </p>
              <p>
              ...
              <p>
                beschrieben werden. Die Funktionsgleichung g mit g(x) = {pp(a)}{' '}
                x² {pp(-a * 2 * data.x_s, 'merge_op')}x + 1
              </p>
              <p>
        ...
        solution({ data }) {
          ...
          return (
            <>
              ...
              <p>
                Setze die Werte für a, b und c in die Mitternachtsformel ein:
              </p>
              <p>
                x<sub>1/2</sub> ={' '}
                {buildInlineFrac(
            ...
            <>
              {data.coin == true ? (
                <p>
                  ...
                  unterschiedliche Scheitelpunktkoordinaten. Der höchste Punkt
                  der Flugbahn ist daher unterschiedlich.
                </p>
              ) : (
                <p>
                  Mögliche Gemeinsamkeit: Die Funktionen besitzen die gleiche
                  Scheitelpunktkoordinate x<sub>s</sub>. Damit erreichen die
                  Flugbahnen beide ihren Höhepunkt nach x<sub>s</sub> ={' '}
                  {data.x_s} Metern. <br></br>
                  <br></br> Mögliche Unterschied: Die Funktionen haben
