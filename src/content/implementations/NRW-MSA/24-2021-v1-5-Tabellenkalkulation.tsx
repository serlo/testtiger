    ...
    main: [
      {
        task({ data }) {
          return (
            <>
              <p>
                Am 1. Juli 2020 wurde in Deutschland befristet die
                Mehrwertsteuer (= MwSt.) von 19% auf 16% gesenkt. Herr Meyer hat
                ein Geschäft für Bekleidung und hat die Senkung der
                Mehrwertsteuer an seine Kunden weitergegeben. Dafür hat er eine
              ...
              <p>
                a) Ergänze die fehlenden Werte in Zeile 4 für den
                Kapuzenpullover.
              </p>
            </>
          )
        ...
        solution({ data }) {
          return (
            <>
              ...
              <p>
                Setze den Preis ohne MwSt. als Grundwert ein. Für den
                Prozentwert können 119 % ≙ 1,19 eingesetzt werden, da es sich um
                eine 19 % - ige Erhöhung des Grundwerts handelt:
              </p>
              <p>
              ...
              <p>
                Mit der gleichen Rechnung wird der Preis für 16 % MwSt.
                berechnet:
              </p>
              <p>
