        ...
        task({ data }) {
          return (
            <>
              ...
              <p>
                a) Entscheide mithilfe des Diagramms ob die Aussage zutrifft
                oder nicht.
              </p>
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                b) Entscheide mithilfe des Diagramms ob die Aussage zutrifft
                oder nicht.
              </p>
              <p>
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                c) Entscheide mithilfe des Diagramms ob die Aussage zutrifft
                oder nicht.
              </p>
              <p>
      ...
      },
      {
        ...
        solution({ data }) {
          return (
            <>
              <p>
                {data.umfrage} Männer aus der Umfrage entsprechen{' '}
                {data.maenner_1} % der Grundgesamtheit.
              </p>
              <p>
              ...
              <p>
                Es wurden etwa{' '}
                {Math.round(data.umfrage / (data.maenner_1 / 100))} Männer
                befragt.
              </p>
            </>
          )
