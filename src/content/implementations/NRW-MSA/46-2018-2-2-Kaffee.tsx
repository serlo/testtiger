    ...
    main: [
      {
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Jede Person trinkt {data.liter} Liter Kaffee, davon{' '}
                {data.percent} % aus Pappbechern. Berechne den Anteil:
              </p>
              <p>
      ...
      },
      {
          ...
          return (
            <>
              <p>
                ...
                Menschen. Karin behauptet: {'"'}Jede Stunde werden in
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Berechne, wie viele Pappbecher jährlich in Deutschland
                verbraucht werden:
              </p>
              <p>
      ...
      },
      {
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Setze die Angaben in die Formel ein und berechne das Volumen:
              </p>
            ...
            <>
              ...
              <svg viewBox="0 0 328 440">
                ...
                <text
                  x={73}
                  y={
                    toY(data.start * Math.pow(data.decay, 5)) + data.error_1 * 4
                  }
                  fontSize={15}
                  textAnchor="right"
                  stroke="black"
                ...
                <text
                  x={95.5}
                  y={
                    toY(data.start * Math.pow(data.decay, 10)) +
                    data.error_2 * 4
                  }
                  fontSize={15}
                  textAnchor="right"
                ...
                <text
                  x={118}
                  y={
                    toY(data.start * Math.pow(data.decay, 15)) +
                    data.error_3 * 3
                  }
                  fontSize={15}
                  textAnchor="right"
                ...
                <text
                  x={139}
                  y={
                    toY(data.start * Math.pow(data.decay, 20)) +
                    data.error_4 * 3
                  }
                  fontSize={15}
                  textAnchor="right"
                ...
                <text
                  x={161.5}
                  y={
                    toY(data.start * Math.pow(data.decay, 25)) +
                    data.error_5 * 3
                  }
                  fontSize={15}
                  textAnchor="right"
          ...
          return (
            <>
              ...
              <ul>
                ...
                <li>
                  Der Anfangswert {data.start} wird mit der Potenz
                  multipliziert, da der Graph sonst die Temperatur {data.start}
                  °C anstrebt.
                </li>
              </ul>
              <p>
