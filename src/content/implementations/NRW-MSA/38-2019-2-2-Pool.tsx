      ...
      return (
        <>
          ...
          <svg viewBox="0 0 328 180">
            <image
              href="/content/NRW_MSA_Pool_2.jpg"
              height="180"
              width="328"
            />
          </svg>
        ...
        solution({ data }) {
          return (
            <>
              ...
              <p>
                Setze die Werte ein und löse die Formel nach der Grundfläche
                auf:
              </p>
              {buildEquation([
                ['V', '=', 'G · h'],
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                c) Das Becken steht auf einer quadratischen Terrasse, die an
                zwei Seiten jeweils {data.terra} cm übersteht (Abbildung 2).
                Bestimme rechnerisch die Maße der Terrasse.
              </p>
          ...
          return (
            <>
              <p>
                ...
                {data.terra} cm ≙ {pp(data.terra / 100)} m und dem Durchmesser
                des Pools.
              </p>
              <p>
            ...
            <>
              <ul>
                <li>
                  ...
                  Fläche, die zum Beginn der Beobachtung (x = 0) von Algen
                  besetzt wird.{' '}
                </li>
                <li>
                  Der Wert {pp(data.growth / 100 + 1)} ist der Wachstumsfaktor
                  der Funktion, der den täglichen Zuwachs von {data.growth} %
                  Algen beschreibt.
                </li>
                <li>
                  f(x), also die Funktionswerte der Funktion, geben die von
                  Algen besetzte Fläche in Abhängigkeit der Tage an.
                </li>
              </ul>
            </>
          )
      ...
      },
      {
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Das Wachstum der Algen wird mit der Funktion f beschrieben.
                Setze x = {data.day} ein und berechne die Fläche.
              </p>
              <p>
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                f) Das Algenwachstum lässt sich mit der Funktionsgleichung nur
                für einen begrenzten Zeitraum darstellen. Erkläre, warum dies so
                ist.
              </p>
            </>
          )
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Wenn die Fläche des Schwimmbeckens vollständig mit Algen
                bewachsen ist, stoppt das Wachstum. <br></br>Die Funktion kann
                das Wachstum also nur bis zu dem Zeitpunkt beschreiben, bis der
                Funktionswert {pp(data.surface)} m² erreicht wird.
              </p>
            </>
          )
        },
