        ...
        solution({ data }) {
          return (
            <>
              ...
              <p>
                Bestimme die Mittelpunkte der oberen Kanten. Stich mit dem
                Zirkel ein und zeichne jeweils einen Halbkreise mit dem Radius{' '}
                {pp(data.kante / 2)} cm.
              </p>
              <svg viewBox="0 0 328 200" className="min-w-[328px]">
                <image
          ...
          return (
            <>
              <p>
                ...
                {buildOverline('AB')} geht durch die Mittelpunkte M1​ und M2​
        ...
        task({ data }) {
          ...
          return (
            <>
              ...
              <p>
                In einem Karton sind {data.red} Herzen rot, die restlichen
                Herzen sind weiß. Begründe, dass sich in dem Karton insgesamt{' '}
