        ...
        solution({ data }) {
          return (
            <>
              ...
              <p>
                Weg, Geschwindigkeit und Zeit hängen über dieses Gesetz
                zusammen:
              </p>
          ...
          return (
            <>
              <p>
                ...
                {züge[0] == (304 - data.x_3) / (54 - 25) && '4'} fährt der Zug
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                Um 8:30 Uhr fährt in Baunatal ein Güterzug nach Frankfurt los.
                Er fährt die Strecke mit einer durchschnittlichen
                Geschwindigkeit von {data.pace_2} Kilometern pro Stunde [km/h].
              </p>
              <p>
