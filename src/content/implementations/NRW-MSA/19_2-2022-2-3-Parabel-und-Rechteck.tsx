      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                b) Begründe mit den Eigenschaften dieser Parabel, dass der Punkt
                B<sub>2</sub>({pp(-data.x)}|{data.y}) ebenfalls auf dem Graphen
                von f liegt.
              </p>
            </>
          )
          ...
          return (
            <>
              <p>
                ...
                man den Punkt B<sub>1</sub>({pp(-data.x)}|{data.y}). Dieser
                liegt also ebenfalls auf dem Graphen von f.
              </p>
            </>
          )
        },
          ...
          return (
            <>
              <p>
                ...
                x-Achse und bilden mit den Punkten A<sub>1</sub> und B
                <sub>1</sub> das Rechteck A<sub>1</sub>B<sub>1</sub>C
                <sub>1</sub>D<sub>1</sub>.
              </p>
      ...
      },
      {
        task({ data }) {
          ...
          return (
            <>
              <p>
                e) Mit dem Term (I) kann man den Umfang für jedes dieser
                Rechtecke berechnen:
              </p>
              <p>
                2 · 2x + 2 · (
              ...
              <p>
                Berechne mit dem Term (I) den Umfang des Rechtecks, das durch
                den Punkt A<sub>2</sub>(1|{pp(b + data.a)}) festgelegt ist.
              </p>
            </>
          )
        },
