    ...
    main: [
      {
        task({ data }) {
          return (
            <>
              <p>
                a) Die Schülerinnen und Schüler messen die Länge {data.length}{' '}
                mm und Breite {data.width} mm am Mikroskop.
              </p>
              <p>
                Bestimme den Maßstab, wenn die {pp(data.mass)} mm in der
                Zeichnung 15 mm am Mikroskop entsprechen. Berechne damit die
          ...
          return (
            <>
              ...
              <p>
                ...
                {pp(roundToDigits((data.length * data.mass) / 15, 2))} mm und
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                b) Im Frühjahr ermitteln sie die Anzahl der Milben im
                Bienenvolk.
              </p>
              <p>
                ...
                voraussichtliche Anzahl der Milben für die kommenden vier und
                acht Wochen. Die Werte halten sie in einer Tabelle fest.
              </p>
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Die Anzahl der Milben verdoppelt sich alle 4 Wochen. Nach 4
                Wochen ist die Anzahl der Milben das doppelte des
                Ausgangswertes, also: {data.count} ⋅ 2 = {data.count * 2}{' '}
                Milben.
              </p>
              <p>
      ...
      },
      {
        task({ data }) {
          return (
            <>
              ...
              <p>
                Gib die Bedeutung der Werte {data.count} und 1,19 im
                Zusammenhang an.
              </p>
            </>
          )
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Den Wert {data.count} nimmt die Funktion zum Zeitpunkt x=0 an,
                er ist also der Anfangswert.{' '}
              </p>
              <p>
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                d) Bestätige mithilfe der Funktionsgleichung, dass nach 12
                Wochen ca.{' '}
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Da in der Funktionsgleichung das x für die Anzahl an Wochen
                steht, musst du für das x die 12 einsetzen und erhältst:{' '}
              </p>
              <p>
          ...
          return (
            <>
              <p>
                ...
                Bienenvolk so großen Schaden nehmen, dass es nicht überleben
                kann.
              </p>
              <p>
                Bestimme, nach wie vielen Wochen die Anzahl von {data.goal}{' '}
                Milben überschritten wird.
              </p>
            </>
          )
        },
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                f) Damit das Bienenvolk überlebt, wird nach 12 Wochen
                Ameisensäure eingesetzt. Dadurch wird die Anzahl von ca.{' '}
                {pp(roundToDigits(Math.pow(1.19, 12) * data.count, -2))} Milben
        ...
        solution({ data }) {
          ...
          return (
            <>
              ...
              <p>
                verwenden. Berechne den Wert nach 21 Wochen. Da 12 Wochen
                bereits vergangen sind bleiben 21 − 12 = 9 Wochen der
                Beobachtung übrig. Setze diesen Wert in die neue
