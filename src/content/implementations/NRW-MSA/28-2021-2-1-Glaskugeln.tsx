          ...
          return (
            <>
              <p>
                ...
                lackiert. Mit einem Liter Farbe kann eine Fläche von{' '}
                {data.paint} m² lackiert werden.
              </p>
              <p>
          ...
          return (
            <>
              ...
              <p>
                O ={' '}
                {pp(
                  Math.round(4 * Math.PI * Math.pow(data.dia / 2, 2) * 100) /
                    100,
                )}{' '}
                cm²
              </p>
              <p>
                Die Farbe reicht für {data.paint} m². Rechne die Fläche in cm²
                um:
              </p>
              <p>
        ...
        solution({ data }) {
          return (
            <>
              ...
              <p>O&apos; = 4 · O</p>
              <p>
                Die Oberfläche einer Kugel mit doppeltem Durchmesser ist 4 mal
                so groß wie die Oberfläche der ursprünglichen Kugel.
              </p>
              <p>
          ...
          return (
            <>
              <p>
                ...
                Anteile. Die Anteile werden im Folgenden als
                Wahrscheinlichkeiten gedeutet.{' '}
              </p>
              <svg viewBox="0 0 700 500">
                <image
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                Begründe, warum der untere Ast des Baumdiagramms nicht
                fortgeführt ist.
              </p>
            </>
          )
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Der untere Ast des Baumdiagramms wird nicht fortgeführt, weil
                alle Glaskugeln, die eine Form mit Fehlern haben, direkt
                aussortiert werden. Sie werden keiner weiteren Kontrolle
                unterzogen.
              </p>
            </>
          )
      ...
      },
      {
        task({ data }) {
          return (
            <>
              <p>
                f) Insgesamt werden {data.control} Glaskugeln kontrolliert.{' '}
              </p>
              <p>
        ...
        solution({ data }) {
          return (
            <>
              <p>
                Berechne zuerst die erwartete Anzahl der Kugeln ohne Fehler in
                der Form:
              </p>
              <p>
