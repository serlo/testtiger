    ...
    main: [
      {
        task({ data }) {
          return (
            <>
              ...
              <p>
                Sinja hat eine nahezu kugelförmige Wassermelone gekauft, die
                einen Durchmesser von ca. {data.durchmesser} cm hat (Abbildung
                1).
              </p>
        ...
        solution({ data }) {
          ...
          return (
            <>
              <p>
                Berechne das Volumen der kugelförmigen Melone mit der Formel:
              </p>
        ...
        task({ data }) {
          return (
            <>
              ...
              <p>
                Berechne den prozentualen Anteil des Fruchtfleisches an der
                ganzen Wassermelone.
              </p>
            </>
          )
